...
EncontrarCategoriasAsignadas($product_categories);




//  categorias asignadas a un envio
function EncontrarCategoriasAsignadas($product_categories){

    $list_cat_asignadas = $_POST['lis_cat_asignadas'];
...
add_action('wp_ajax_encontrar_cat_asignada', 'EncontrarCategoriasAsignadas');
